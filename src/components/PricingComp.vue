<template>
    ...
    <!-- Pricing Start -->
    <div class="container-fluid mx-auto" style="margin: 90px 0;">
            ...
            <div class="row">
                <div class="col-lg-5" style="min-height: 500px;">
                    ...
                    <div class="position-relative h-100">
                        ...
                        <img class="position-absolute w-100 h-100" src="../img/instalaciones-primera-clase.jpg" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-7 pt-5 pb-lg-5">
                    <h4 class="d-inline-block text-primary text-uppercase bg-light py-1 px-2">Spa Center Prices</h4>
                    <h2 class="mb-4">Modules and Plans</h2>
